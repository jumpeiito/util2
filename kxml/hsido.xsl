...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
  ...
  <xsl:template match="/">
	...
	<table border="1">
	  ...
	  <tr><td class="first">初回面接の実施日付</td><td><xsl:value-of select="//h:code[@codeSystem='1.2.392.200119.6.3003']/../h:effectiveTime/@value" /></td></tr>
	  <tr>
	    <td class="first">初回面接の実施者</td>
	    <td>
	      <xsl:choose>
	  ...
	  <tr>
	    <td class="first">一日の削減目標エネルギー量</td>
	    <td>
	  ...
	  <tr>
	    <td class="first">一日の運動による目標エネルギー量</td>
	    <td>
	  ...
	  <tr>
	    <td class="first">一日の食事による目標エネルギー量</td>
	    <td>
	  ...
	  <tr><td class="plan">計画上の継続的な支援の実施回数</td><td><xsl:value-of select="//h:code[@code='1041800117']/../h:value/@value" />回</td></tr>
	  <tr><td class="plan">計画上の個別支援A回数</td><td><xsl:value-of select="//h:code[@code='1041101117']/../h:value/@value"/>回</td></tr>
	  <tr>
	    <td class="plan">計画上の個別支援A合計実施時間</td>
	    <td>
	      <xsl:value-of select="//h:code[@code='1041101113']/../h:value/@value"/>
	      <xsl:value-of select="//h:code[@code='1041101113']/../h:value/@unit"/>
	    </td>
	  </tr>
	  <tr><td class="plan">計画上の個別支援B回数</td><td><xsl:value-of select="//h:code[@code='1041201117']/../h:value/@value"/>回</td></tr>
	  <tr>
	    <td class="plan">計画上の個別支援B合計実施時間</td>
	    <td>
	      <xsl:value-of select="//h:code[@code='1041201113']/../h:value/@value"/>
	      <xsl:value-of select="//h:code[@code='1041201113']/../h:value/@unit"/>
	    </td>
	  </tr>
	  <tr><td class="plan">計画上のグループ支援回数</td><td><xsl:value-of select="//h:code[@code='1041302117']/../h:value/@value"/>回</td></tr>
	  <tr>
	    <td class="plan">計画上のグループ支援合計実施時間</td>
	    <td>
	      <xsl:value-of select="//h:code[@code='1041302113']/../h:value/@value"/>
	      <xsl:value-of select="//h:code[@code='1041302113']/../h:value/@unit"/>
	    </td>
	  </tr>
	  <tr><td class="plan">計画上の電話A支援回数</td><td><xsl:value-of select="//h:code[@code='1041103117']/../h:value/@value"/>回</td></tr>
	  <tr>
	    <td class="plan">計画上の電話A支援合計実施時間</td>
	    <td>
	      <xsl:value-of select="//h:code[@code='1041103113']/../h:value/@value"/>
	      <xsl:value-of select="//h:code[@code='1041103113']/../h:value/@unit"/>
	    </td>
	  </tr>
	  <tr><td class="plan">計画上のe-mailA支援回数</td><td><xsl:value-of select="//h:code[@code='1041104117']/../h:value/@value"/>回</td></tr>
	  <tr><td class="plan">計画上の電話B支援回数</td><td><xsl:value-of select="//h:code[@code='1041203117']/../h:value/@value"/>回</td></tr>
	  <tr>
	    <td class="plan">計画上の電話B支援合計実施時間</td>
	    <td>
	      <xsl:value-of select="//h:code[@code='1041203113']/../h:value/@value"/>
	      <xsl:value-of select="//h:code[@code='1041203113']/../h:value/@unit"/>
	    </td>
	  </tr>
	  <tr><td class="plan">計画上のe-mailB支援回数</td><td><xsl:value-of select="//h:code[@code='1041204117']/../h:value/@value"/>回</td></tr>
	  <tr><td class="plan">計画上の支援Aポイント</td><td><xsl:value-of select="//h:code[@code='1041100114']/../h:value/@value" /></td></tr>
	  <tr><td class="plan">計画上の支援Bポイント</td><td><xsl:value-of select="//h:code[@code='1041200114']/../h:value/@value" /></td></tr>
	  <tr><td class="plan">計画上の支援ポイント合計</td><td><xsl:value-of select="//h:code[@code='1041800114']/../h:value/@value" /></td></tr>

	  <tr><td class="result">実施上の継続的な支援の実施回数</td><td><xsl:value-of select="//h:code[@code='1042800117']/../h:value/@value" />回</td></tr>
	  <tr><td class="result">実施上の個別支援A回数</td><td><xsl:value-of select="//h:code[@code='1042101117']/../h:value/@value"/>回</td></tr>
	  <tr>
	    <td class="result">実施上の個別支援A合計実施時間</td>
	    <td>
	      <xsl:value-of select="//h:code[@code='1042101113']/../h:value/@value"/>
	      <xsl:value-of select="//h:code[@code='1042101113']/../h:value/@unit"/>
	    </td>
	  </tr>
	  <tr><td class="result">実施上の個別支援B回数</td><td><xsl:value-of select="//h:code[@code='1042201117']/../h:value/@value"/>回</td></tr>
	  <tr>
	    <td class="result">実施上の個別支援B合計実施時間</td>
	    <td>
	      <xsl:value-of select="//h:code[@code='1042201113']/../h:value/@value"/>
	      <xsl:value-of select="//h:code[@code='1042201113']/../h:value/@unit"/>
	    </td>
	  </tr>
	  <tr><td class="result">実施上のグループ支援回数</td><td><xsl:value-of select="//h:code[@code='1042302117']/../h:value/@value"/>回</td></tr>
	  <tr>
	    <td class="result">実施上のグループ支援合計実施時間</td>
	    <td>
	      <xsl:value-of select="//h:code[@code='1042302113']/../h:value/@value"/>
	      <xsl:value-of select="//h:code[@code='1042302113']/../h:value/@unit"/>
	    </td>
	  </tr>
	  <tr><td class="result">実施上の電話A支援回数</td><td><xsl:value-of select="//h:code[@code='1042103117']/../h:value/@value"/>回</td></tr>
	  <tr>
	    <td class="result">実施上の電話A支援合計実施時間</td>
	    <td>
	      <xsl:value-of select="//h:code[@code='1042103113']/../h:value/@value"/>
	      <xsl:value-of select="//h:code[@code='1042103113']/../h:value/@unit"/>
	    </td>
	  </tr>
	  <tr><td class="result">実施上のe-mailA支援回数</td><td><xsl:value-of select="//h:code[@code='1042104117']/../h:value/@value"/>回</td></tr>
	  <tr><td class="result">実施上の電話B支援回数</td><td><xsl:value-of select="//h:code[@code='1042203117']/../h:value/@value"/>回</td></tr>
	  <tr>
	    <td class="result">実施上の電話B支援合計実施時間</td>
	    <td>
	      <xsl:value-of select="//h:code[@code='1042203113']/../h:value/@value"/>
	      <xsl:value-of select="//h:code[@code='1042203113']/../h:value/@unit"/>
	    </td>
	  </tr>
	  <tr><td class="result">実施上のe-mailB支援回数</td><td><xsl:value-of select="//h:code[@code='1042204117']/../h:value/@value"/>回</td></tr>
	  <tr><td class="result">実施上の支援Aポイント</td><td><xsl:value-of select="//h:code[@code='1042100114']/../h:value/@value" /></td></tr>
	  <tr><td class="result">実施上の支援Bポイント</td><td><xsl:value-of select="//h:code[@code='1042200114']/../h:value/@value" /></td></tr>
	  <tr><td class="result">実施上の支援ポイント合計</td><td><xsl:value-of select="//h:code[@code='1042800114']/../h:value/@value" /></td></tr>
	  <tr><td class="result">実施上の継続的支援終了日</td><td><xsl:value-of select="//h:code[@code='1042000022']/../h:value" /></td></tr>
	  <tr><td class="inter">中間評価日時</td><td><xsl:value-of select="//h:code[@codeSystem='1.2.392.200119.6.3004']/../h:effectiveTime/@value" /></td></tr>
	  <tr>
	    <td class="inter">中間評価の支援形態または確認方法</td>
	    <td>
	      <xsl:choose>
	  ...
	  <tr>
	    <td class="inter">中間評価時の生活習慣の改善(栄養・食生活)</td>
	    <td>
	      <xsl:choose>
	  ...
	  <tr>
	    <td class="inter">中間評価時の生活習慣の改善(身体活動)</td>
	    <td>
	      <xsl:choose>
	  ...
	  <tr>
	    <td class="inter">中間評価時の生活習慣の改善(喫煙)</td>
	    <td>
	      <xsl:choose>
	  ...
	  <tr><td class="final">最終評価日時</td><td><xsl:value-of select="//h:code[@codeSystem='1.2.392.200119.6.3005']/../h:effectiveTime/@value" /></td></tr>
	  <tr>
	    <td class="final">最終評価の支援形態</td>
	    <td>
	      <xsl:choose>
	  ...
	  <tr>
	    <td class="final">最終評価時の生活習慣の改善(栄養・食生活)</td>
	    <td>
	      <xsl:choose>
	  ...
	  <tr>
	    <td class="final">最終評価時の生活習慣の改善(身体活動)</td>
	    <td>
	      <xsl:choose>
	  ...
	  <tr>
	    <td class="final">最終評価時の生活習慣の改善(喫煙)</td>
	    <td>
	      <xsl:choose>
	  ...
	  <tr><td class="final">禁煙の指導回数</td><td><xsl:value-of select="//h:code[@code='1042800118']/../h:value/@value" />回</td></tr>
	  <tr><td class="final">最終評価できない場合の確認回数</td><td><xsl:value-of select="//h:code[@code='1042000116']/../h:value/@value" />回</td></tr>
	</table>

	<table border="1">
	  <tr>
	    <td class="title">支援実施形態</td>
	    <td class="title">支援実施日付</td>
	    <td class="title">支援実施者</td>
	    <td class="title">支援A時間</td>
	    <td class="title">支援Apt</td>
	    <td class="title">支援B時間</td>
	    <td class="title">支援Bpt</td>
	  </tr>
